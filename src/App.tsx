...
export default function App() {
  ...
  useEffect(() => {
    const apply = () => {
      ...
      document.documentElement.style.setProperty('--font-family-main', "'Inter', Arial, sans-serif");
  ...
  const toggleSidebar = () => setNavMode(isWide ? 'sidebar-slim' : 'sidebar-wide');
  ...
  return (
    <div className="forge-app">
      <NavRail variant="topbar" isWide={isWide} navColor={sidebarColor} activePage={activePage} setActivePage={handlePageChange} toggleSidebar={toggleSidebar} onOpenSettings={() => setShowSettings(true)}/>
      <div className="forge-body">
        <NavRail variant="sidebar" isWide={isWide} navColor={sidebarColor} activePage={activePage} setActivePage={handlePageChange} toggleSidebar={toggleSidebar} onOpenSettings={() => setShowSettings(true)}/>
